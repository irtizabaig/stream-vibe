...
const SearchMovie = ({data}) => {
  ...
  return (
    <div
    onClick={()=>navigate(`/movie-detail/${data.id}`)}
     className="border border-[#262626] rounded-[10px] bg-[#1a1a1a] lg:p-5 p-3 lg:min-h-[280px] lg:w-[250px] lg:w-70 w-45 h-70 flex flex-col justify-between overflow-hidden hover:border-[rgba(229,0,0,0.72)] hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                    >
