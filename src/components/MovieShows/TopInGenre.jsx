  ...
  return (
    <div className="w-[min(1300px,calc(100%-40px))] mx-auto mt-10">
        ...
        <div className="flex items-center justify-between gap-[30px] mb-10">
            ...
            <h1 className='text-3xl'>Popular Top 10 in Genre</h1>
        ...
        >
          ...
          {[...data].reverse().map((genre)=>{
            return <SwiperSlide key={genre.id}>
            <div onClick={()=> navigate(`/genre?genre=${genre.id}&type=${type}&mode=top10`)} className="border border-[#262626] rounded-[10px] bg-[#1a1a1a] p-5 min-h-[280px] flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between text-white font-semibold">
                <div>
                  <p className='bg-red-600 py-2 px-3 text-sm rounded-md mb-2'>Top 10 in</p>
