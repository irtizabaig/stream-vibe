  ...
  return (
     <div className="w-[min(1300px,calc(100%-40px))] mx-auto mt-10">
        ...
        <div className="flex items-center justify-between gap-[30px] mb-10">
            ...
            <h1 className='text-3xl'>Must - Watch Movies</h1>
        ...
        {data.map((e)=>{
          return <SwiperSlide key={e.id}>
            <div onClick={()=> navigate(e.release_date ? `/movie-detail/${e.id}` : `/show-detail/${e.id}`)} className="border border-[#262626] rounded-[10px] bg-[#1a1a1a] p-5 min-h-[400px] flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between text-white font-semibold">
                ...
                <div className='flex gap-1 border rounded-full py-1 px-2'>
                    ...
                    <p className='text-sm font-light'>1h 30min</p>
                </div>
                
                <div className='flex gap-1 border rounded-full py-1 px-2'>
                        <Star fill='red' size={18} />
                    <p className='text-sm font-light'>{Math.round(e.popularity)}K</p>
                </div>
              </div>
